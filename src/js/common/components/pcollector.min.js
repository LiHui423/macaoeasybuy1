...
var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
    ...
    pcollector = {
        ...
        methods: {
            ...
            insertHTML: function () {
                var t = this.$methods;
                $('head > link[rel="stylesheet"]:last').after('<link rel="stylesheet" href="/css/common/components/pcollector.min.css">'), $('#pcollector').load('/page/common/components/pcollector.html .pcollector-panel'), t.bindEvent()
            },
            bindEvent: function () {
                var t = this.$settings,
                    e = this.$methods;
